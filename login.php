            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
					...
					<input type="submit" value="送信">
                                        ...
                                        <a href="https://ibmkeiba.github.io/webdesign/" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </a>
                                        <hr>
                                        <a href="https://github.com/login/oauth/authorize?client_id=38b8b555524ed6c4c3f0" class="btn btn-GitHub btn-user btn-block">
                                            <i class="fab fa-github"></i>
						Login with GitHub
                                        </a>
                                        <a href="https://ibmkeiba.github.io/webdesign/" class="btn btn-facebook btn-user btn-block">
                                            <i class="fab fa-facebook-f fa-fw"></i> Login with Facebook
                                        </a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="https://ibmkeiba.github.io/webdesign/forgot-password.html">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="https://ibmkeiba.github.io/webdesign/register.html">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
